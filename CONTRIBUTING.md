# Contributing Guidelines for SCRAPIE

This documentation contains a set of guidelines to help you during the contribution process. 
We are happy to welcome you to SCRAPIE, have a nice contributing journey.
...
```
$ git clone https://github.com/<your-username>/SCRAPIE
$ flask run
```
